...
Resubmission: upload `findra_0.4.2.0.msixbundle` on the Packages page (replacing 0.3.1), set
"What's new in this version" from the 0.4.2, 0.4.1 and 0.4.0 CHANGELOG sections, and add to the notes for
